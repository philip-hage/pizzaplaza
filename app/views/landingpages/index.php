...
<!-- <a class="btn btn-primary" href="<?= URLROOT; ?>pizzacontroller/pizzaOverview/1/">Pizza Overview</a> -->
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="customer.html" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Customer</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="customers.html" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Customers</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="timeline.html" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Timeline</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="log-in.html" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Login</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="sign-up.html" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Sign Up</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="password-reset.html" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Password Reset</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="404.html" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">404</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
